loadText = () => {
    ...
    const textCont = {
        ...
        en: {
            ...
            servicesInfo: {
                ...
                offers: {
                    basic: {
                        header: 'Basic',
                        price: '99€',
                        content: ['DESIGN OPTIONAL (ready offered)', 'GALLERY (20 photo)', 'Monolingual', 'Up to 5 functional links', '2 email addresses']
                    },
                    pro: {
                        header: 'Pro',
                        price: '199€',
            ...
            aboutHeader: 'About',
            aboutInfo: 'Click-Box is a team of professionals with experience in web solution creation. \
        ...
        mk: {
            ...
            servicesInfo: {
                disclaimer: '* Цената од 99 евра се однесува за веке готови дизајни само со промена на слики и на содржина секоја друга промена подложи на промена на цена по договор | * Времето за изработка од 7 дена однесува за веке готови дизајни само со промена на слики и на содржина секоја друга промена подложи на промена на времето за изработка | * Фотографиите и текстот ги обезбедува клиентот во фигитална форма',
                offers: {
                    basic: {
                        header: 'Основен',
                        price: '99€',
            ...
            aboutHeader: 'За Нас',
            aboutInfo: 'Click-Box е тим од професионалци со искуство во креирањето на веб решенија.\
                    Ние ви нудиме загарантирано најдобри Веб решенија. \
                    Со нашиот стручен тим за кратко време вашите идеи можат да бидат реализирани.\
